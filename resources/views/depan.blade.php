@php
$logo = get_section('logo');
$about = get_section('about');

$site_name = get_setting('_site_name');
$location = get_setting('_location');
$site_decs = get_setting('_site_decs');

$youtube = get_setting('_youtube');
$ig = get_setting('_ig');
$x = get_setting('_x');
$facebook = get_setting('_facebook');
  ...
  <body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container d-flex align-items-center flex-column">
        ...
        <img class="masthead-avatar mb-5" src="{{Storage::url($logo->thumbnail) }}"alt="..." />
        <!-- Masthead Heading-->
        <h1 class="masthead-heading text-uppercase mb-0">{{$logo->title}}</h1>
        <!-- Icon Divider-->
        ...
        <!-- Masthead Subheading-->
        <p class="masthead-subheading font-weight-light mb-0">{!! strip_tags($logo->content)!!}</p>
      </div>
    </header>
    <!-- Partner Section-->
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 mb-5 mb-lg-0">
            ...
            @endif
            @if($ig)
            <a class="btn btn-outline-light btn-social mx-1" href="{{$ig}}"target="blank"><i class="fab fa-fw fa-instagram"></i></a>
            @endif
            @if($x)
            <a class="btn btn-outline-light btn-social mx-1" href="{{$x}}"target="blank"><i class="fab fa-fw fa-twitter"></i></a>
            @endif
            @if($facebook)
